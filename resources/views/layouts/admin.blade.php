    ...
    <aside class="hidden md:flex w-64 bg-indigo-900 text-indigo-100 flex-col p-6 space-y-8 sticky top-0 h-screen shadow-2xl">
        ...
        <nav class="flex-1 space-y-2">
            ...
            <a href="{{ route('admin.dashboard') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-xl font-semibold transition-all duration-200 {{ request()->routeIs('admin.dashboard') ? 'bg-indigo-800 text-white shadow' : 'hover:bg-indigo-800 hover:text-white' }}">
            ...
            <a href="{{ route('admin.categories.index') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-xl font-semibold transition-all duration-200 {{ request()->routeIs('admin.categories.*') ? 'bg-indigo-800 text-white shadow' : 'hover:bg-indigo-800 hover:text-white' }}">
            ...
            <a href="{{ route('admin.events.index') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-xl font-semibold transition-all duration-200 {{ request()->routeIs('admin.events.*') ? 'bg-indigo-800 text-white shadow' : 'hover:bg-indigo-800 hover:text-white' }}">
            ...
            <a href="{{ route('admin.partners.index') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-xl font-semibold transition-all duration-200 {{ request()->routeIs('admin.partners.*') ? 'bg-indigo-800 text-white shadow' : 'hover:bg-indigo-800 hover:text-white' }}">
            ...
            <a href="{{ route('admin.transactions.index') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-xl font-semibold transition-all duration-200 {{ request()->routeIs('admin.transactions.*') ? 'bg-indigo-800 text-white shadow' : 'hover:bg-indigo-800 hover:text-white' }}">
            ...
            <!-- MENU SCAN CHECK-IN (DITAMBAHKAN DI SINI) -->
            <a href="{{ route('admin.checkin.index') }}"
               class="flex items-center gap-3 px-4 py-3 rounded-xl font-semibold transition-all duration-200 {{ request()->routeIs('admin.checkin.*') ? 'bg-indigo-800 text-white shadow' : 'hover:bg-indigo-800 hover:text-white' }}">
