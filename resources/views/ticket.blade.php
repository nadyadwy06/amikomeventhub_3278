    ...
    <div class="max-w-md w-full">
        ...
        <div class="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div class="p-6 bg-indigo-50 text-center border-b border-dashed border-indigo-200">
                <p class="text-indigo-600 text-xs font-bold tracking-widest uppercase">E-TICKET RESMI</p>
            ...
            <div class="p-6 bg-slate-50 border-t border-dashed">
                ...
                <a href="/" class="block text-center mt-4 text-sm text-slate-500 hover:text-indigo-600 transition">
                    Kembali ke Home
                </a>
            </div>
        </div>
